...
public class Manager
{
    ...
    /**
     * Constructor for making a manager without a given file path
     */
     ...
     */
    public void checkFileForWriteRead(boolean writeFlag) throws IOException
    {
        boolean stop = false;
            ...
            for (int i = 0; i < contents.size(); i++)
            {
                ...
                switch (commandArguments[0])
                {
                    ...
                    case "remove_greater":
                        ...
                        break;
                    case "execute_script":
                        if (!filePaths.contains(commandArguments[1]))
                            this.executeScript(commandArguments[1]);
                        else
                        {
